...
const checks = [
  ...
  ["row 1 verified export Y", rows[0].verifiedFiveStar === "Y"],
  ...
  ["row 2 verified export N", rows[1].verifiedFiveStar === "N"],
  ...
  ["row 5 ticketless verified export N", rows[4].verifiedFiveStar === "N"],
