...
assertEqual(batchReviewPackage.summary.summary.estimatedBonusTotal, 180, "Rows with model reminders should keep updated bonus behavior.");
...
assertEqual(batchSummarySheet.getRow(2).getCell(2).value, 11, "Summary sheet should count all batch reviews.");
...
assertEqual(batchSummarySheet.getRow(3).getCell(2).value, 180, "Summary sheet should calculate the batch bonus total.");
...
assertEqual(summaryValue("PureDrop"), 1, "Summary sheet should include PureDrop platform count.");
