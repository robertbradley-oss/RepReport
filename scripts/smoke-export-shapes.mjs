...
assertEqual(batchReviewPackage.summary.summary.estimatedBonusTotal, 155, "Rows with model reminders should keep updated bonus behavior.");
...
assertEqual(batchSummarySheet.getRow(3).getCell(2).value, 155, "Summary sheet should calculate the batch bonus total.");
